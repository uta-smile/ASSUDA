...
class TrainOptions():
    def initialize(self):
        ...
        ### Attack related ###
        parser.add_argument("--seed", type=int, default=72, help="Random seed. Default is 72")
        parser.add_argument("--save-purt", type=int, default=5000, help="The frequency of saving purturted images")
        parser.add_argument("--alpha", type=float, default=0.1, help="magnitude of the attack in FGSM.")
        parser.add_argument("--lambda-contrastive", type=float, default=0.0001, help="trade off for the contrastive loss.") 
